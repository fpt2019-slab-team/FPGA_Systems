...
#
# Generated by Vivado on Mon Sep 30 01:10:41 JST 2019
...
compile()
{
  ...
  vlogan -work xilinx_vip $vlogan_opts -sverilog +incdir+"$ref_dir/../../../ipstatic" +incdir+"/home/cad/xilinx-vivado-2018.3/Vivado/2018.3/data/xilinx_vip/include" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts -sverilog +incdir+"$ref_dir/../../../ipstatic" +incdir+"/home/cad/xilinx-vivado-2018.3/Vivado/2018.3/data/xilinx_vip/include" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"$ref_dir/../../../ipstatic" +incdir+"/home/cad/xilinx-vivado-2018.3/Vivado/2018.3/data/xilinx_vip/include" \
    "$ref_dir/../../../../proj.srcs/sources_1/ip/clk_wiz_0/clk_wiz_0_clk_wiz.v" \
    "$ref_dir/../../../../proj.srcs/sources_1/ip/clk_wiz_0/clk_wiz_0.v" \
  2>&1 | tee -a vlogan.log
