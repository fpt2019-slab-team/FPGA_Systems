...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set camsel [ create_bd_port -dir O camsel ]
  ...
  set r_addr [ create_bd_port -dir O -from 18 -to 0 r_addr ]
  set r_data [ create_bd_port -dir I -from 7 -to 0 r_data ]
  set sccb_busy [ create_bd_port -dir I sccb_busy ]
  set sccb_rdata [ create_bd_port -dir I -from 7 -to 0 sccb_rdata ]
  set sccb_req [ create_bd_port -dir O sccb_req ]
  set sccb_wdata [ create_bd_port -dir O -from 31 -to 0 sccb_wdata ]
  set sccb_wr [ create_bd_port -dir O sccb_wr ]
  set sw [ create_bd_port -dir I -from 1 -to 0 sw ]
  set w_busy [ create_bd_port -dir I w_busy ]
  set w_req [ create_bd_port -dir O w_req ]
  ...
  connect_bd_net -net myip_0_camsel [get_bd_ports camsel] [get_bd_pins myip_0/camsel]
  ...
  connect_bd_net -net myip_0_r_addr [get_bd_ports r_addr] [get_bd_pins myip_0/r_addr]
  connect_bd_net -net myip_0_sccb_req [get_bd_ports sccb_req] [get_bd_pins myip_0/sccb_req]
  connect_bd_net -net myip_0_sccb_wdata [get_bd_ports sccb_wdata] [get_bd_pins myip_0/sccb_wdata]
  connect_bd_net -net myip_0_sccb_wr [get_bd_ports sccb_wr] [get_bd_pins myip_0/sccb_wr]
  connect_bd_net -net myip_0_w_req [get_bd_ports w_req] [get_bd_pins myip_0/w_req]
  ...
  connect_bd_net -net r_data_0_1 [get_bd_ports r_data] [get_bd_pins myip_0/r_data]
  ...
  connect_bd_net -net sccb_busy_0_1 [get_bd_ports sccb_busy] [get_bd_pins myip_0/sccb_busy]
  connect_bd_net -net sccb_rdata_0_1 [get_bd_ports sccb_rdata] [get_bd_pins myip_0/sccb_rdata]
  connect_bd_net -net sw_0_1 [get_bd_ports sw] [get_bd_pins myip_0/sw]
  connect_bd_net -net w_busy_0_1 [get_bd_ports w_busy] [get_bd_pins myip_0/w_busy]
